...
@Entity
@Table(name = "category_product_summary", indexes = {@Index(name = "category_product_summary_product", columnList = "product")})
@NoArgsConstructor
@AllArgsConstructor
public class CategoryProductSummary implements ProductSummary {
    @Id
